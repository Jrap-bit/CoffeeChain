...
# infura_url = 'https://sepolia.infura.io/v3/your_infura_id' # Use this for Infura
infura_url = 'http://127.0.0.1:7545' # Use this for Ganache
web3 = Web3(Web3.HTTPProvider(infura_url))

contract_address = 'YOUR_CONTRACT_ADDRESS' # Replace this with your contract address
